    ...
    <>
      <section className="relative pt-32 pb-16 overflow-hidden section-navy">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-heading text-4xl font-bold mb-8 gradient-text leading-tight py-1">WorshipBuddy Terms of Service</h1>
      ...
      <section className="section-light py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">1) Who we are</h2>
            <p className="text-gray-500 mb-4">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">2) Privacy and security</h2>
            <p className="text-gray-500 mb-4">
            ...
            <p className="text-gray-500">
              <a href="/privacy-security" className="text-brand hover:text-brand/80">View Privacy & Security Policy</a>
            </p>
          </div>

          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">3) Eligibility and accounts</h2>
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">4) Service-specific notes</h2>

            <div className="space-y-6">
              <div>
                <h3 className="font-heading text-lg font-semibold mb-3 text-gray-900">4.1 WorshipBuddy</h3>
                <p className="text-gray-500">
              ...
              <div>
                <h3 className="font-heading text-lg font-semibold mb-3 text-gray-900">4.2 ChurchBuddy</h3>
                <p className="text-gray-500">
              ...
              <div>
                <h3 className="font-heading text-lg font-semibold mb-3 text-gray-900">4.3 PresenterBuddy / PresenterBuddy Studio</h3>
                <p className="text-gray-500">
              ...
              <div>
                <h3 className="font-heading text-lg font-semibold mb-3 text-gray-900">4.4 WorshipBuddyAPI</h3>
                <p className="text-gray-500">
              ...
              <div>
                <h3 className="font-heading text-lg font-semibold mb-3 text-gray-900">4.5 ChurchBuddy Donations (Stripe integration)</h3>
                <p className="text-gray-500 mb-4">
                  ChurchBuddy may provide optional features for churches/organizations to accept donations.
                </p>
                <ul className="list-disc space-y-2 text-gray-500 ml-4 mb-4">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">5) Donations to WorshipBuddy Company (separate from Stripe)</h2>
            <p className="text-gray-500">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">6) Acceptable Use</h2>
            <p className="text-gray-500 mb-4">
              You agree not to misuse the Services. Your use is also governed by our Acceptable Use Policy:
            </p>
            <p className="text-gray-500">
              <a href="/acceptable-use" className="text-brand hover:text-brand/80">View Acceptable Use Policy</a>
            </p>
          </div>

          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">7) Intellectual property</h2>
            <ul className="list-disc space-y-2 text-gray-500 ml-4">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">8) User content</h2>
            <p className="text-gray-500 mb-4">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">9) Third-party services</h2>
            <p className="text-gray-500 mb-4">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">10) Availability, changes, and termination</h2>
            <ul className="list-disc space-y-2 text-gray-500 ml-4">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">11) Disclaimers</h2>
            <p className="text-gray-500">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">12) Limitation of liability</h2>
            <p className="text-gray-500">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">13) Indemnification</h2>
            <p className="text-gray-500">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">14) Governing law and disputes</h2>
            <p className="text-gray-500">
          ...
          <div className="card p-8">
            <h2 className="font-heading text-2xl font-bold mb-6 text-gray-900">15) Contact</h2>
            <p className="text-gray-500">
              Questions about these Terms: <a href="mailto:support@worshipbuddy.org" className="text-brand hover:text-brand/80">support@worshipbuddy.org</a>
            </p>
          </div>
        </div>
      </section>
