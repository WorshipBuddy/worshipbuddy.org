            ...
            <div className="space-y-8 text-gray-900">
              ...
              <div className="p-6 rounded-xl bg-gray-50">
                ...
                <p className="mb-6 text-gray-600">
                  We use Zeffy as our provider to process transactions, a completely free payment processing platform. They will ask for a tip to help support their platform but this <strong>is optional</strong>. Choose any amount—every dollar helps. Your gift supports worship teams around the world. If you&apos;d like to contribute with Apple or Google Pay,{" "}
                  <a 
