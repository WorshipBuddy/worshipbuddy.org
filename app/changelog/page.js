        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-16">
            ...
            {activeSection === "worshipbuddy" && (
              <div id="worshipbuddy" className="section-card">
            ...
            {activeSection === "presenterbuddy" && (
              <div id="presenterbuddy" className="section-card">
            ...
            {activeSection === "schedulebuddy" && (
              <div id="schedulebuddy" className="section-card">
            ...
            {activeSection === "upcomingfeatures" && (
              <div id="upcomingfeatures" className="section-card">
