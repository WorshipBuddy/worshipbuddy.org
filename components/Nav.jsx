...
export default function Nav() {
  ...
  const rightNavItems = [
    { name: "Merch", href: "https://threads.worshipbuddy.org", external: true},
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#f1f5f9] backdrop-blur-sm border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex md:items-center md:space-x-6">
              ...
              <div className="relative">
                ...
                >
                  <span>Resources</span>
                  <FaChevronDown className={`transition-transform duration-200 ${resourcesOpen ? 'rotate-180' : ''}`} />
                </button>
          ...
          {/* Right side - Right navigation items */}
          <div className="hidden md:flex md:items-center md:space-x-6">
